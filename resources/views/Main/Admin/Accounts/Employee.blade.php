        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-4 mb-4">              
                    <h3 class="mb-0 fw-bold">Employee Accounts</h3>             
                </div>
            </div>
        </div>
            ...
            <div class="col-12 mb-5">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center border-0">
                        <span></span>
                        <button class="btn btn-secondary btn-sm" id="table_employee_refresh">
                            <i class="bi bi-arrow-clockwise"></i> Refresh
                        </button>
                    </div>

                    <div class="card-body">
                        <table id="table_employee" class="table table-responsive" style="width: 100%;">
    ...
    <script>
        $(document).ready(function () {
            table = $('#table_employee').DataTable({
                ajax: {
                    url: "{{ route('Admin.Accounts.Employee.Data.Index') }}",
                    async : false,
                    dataSrc: "data",
                },
                order: [[0, 'desc']],
