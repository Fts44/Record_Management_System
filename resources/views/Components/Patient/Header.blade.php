                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end" aria-labelledby="dropdownNotification">
                    ...
                    <div>
                        ...
                        <ul class="list-group list-group-flush notification-list-scroll bg-light">
                            ...
                            @if($notification['incomplete_data']['personal_information'])
                            ...
                            @if($notification['incomplete_data']['emergency_contact'])
                                <li class="list-group-item border-bottom">
                                    <a href="{{ route('Patient.Profile.Index') }}" class="text-muted">
            ...
            <li class="dropdown ms-2">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                    <div class="px-4 pb-0 pt-2">
                        <div class="lh-1">
                            <h5 class="mb-1 display-name">{{ $first_name.' '.$middle_name[0].'. '.$last_name }}</h5>
